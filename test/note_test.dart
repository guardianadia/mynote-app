...
void main() {
  group('Note model tests', () {
    ...
    test('Note toMap and fromMap preserve data', () {
      ...
      expect(
        recreated.updatedAt.toIso8601String(),
        original.updatedAt.toIso8601String(),
      );
    });

    test('Note.fromMap works with old data missing optional fields', () {
    ...
    test('Note.toMap uses Supabase field names', () {
      final now = DateTime(2026, 3, 2, 10, 0);

      final note = Note(
        id: 'supa1',
        title: 'Supabase Note',
        content: 'Check field names',
        folder: 'General',
        category: 'General',
        tags: const ['test'],
        createdAt: now,
